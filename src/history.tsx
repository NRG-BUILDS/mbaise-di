    ...
    <section className="bg-white no-dark:bg-gray-900" id="history">
      <div className="container mx-auto px-6 py-10">
        ...
        <div className="mx-auto mt-6 flex justify-center">
          <span className="inline-block h-1 w-40 rounded-full bg-brown-500"></span>
          <span className="mx-1 inline-block h-1 w-3 rounded-full bg-brown-500"></span>
          <span className="inline-block h-1 w-1 rounded-full bg-brown-500"></span>
        </div>
