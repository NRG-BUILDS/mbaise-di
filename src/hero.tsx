    ...
    <div className="container mx-auto px-6 py-10 text-center">
      <div className="mx-auto max-w-lg">
        ...
        <div className="flex items-center justify-center gap-3 my-3">
          <a
            href="#who-are-we"
            className=" inline-block  rounded-lg bg-beige-600 px-6 py-2.5 text-center text-sm font-medium capitalize leading-5 text-white hover:bg-beige-500 focus:outline-none lg:mx-0 lg:w-auto"
          >
            Learn More
          </a>
